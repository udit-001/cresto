...
// Client is a minimal MCP Streamable HTTP client. It speaks JSON-RPC 2.0
// over POST to an MCP endpoint. Responses come back as either a single
...
// auth (e.g. {"Authorization": "Bearer token"} for Groww, {"Mcp-Session-Id":
// "session-id"} for Kite). The caller owns auth state; this module owns
// transport, encoding, and SSE parsing.
//
...
// request. Defaults to "2025-06-18" (modern). Kite uses "2025-03-26".
